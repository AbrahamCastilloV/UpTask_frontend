...
export default function OlvidePassword() {
  ...
  return (
    ...
    {msg && <Alerta alerta={alerta}/>}
        ...
        <input type="submit" value='Enviar Instrucciones' className="bg-sky-700 w-full py-3 text-white uppercase font-bold rounded hover:bg-sky-800 cursor-pointer transition-colors mb-5" />
    </form>
